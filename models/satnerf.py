...
def inference(model, args, rays_xyz, z_vals, rays_d=None, sun_d=None, rays_t=None, z_vals_unsort=None):
    """
...
class SatNeRF(torch.nn.Module):
    def __init__(self, layers=8, feat=256, mapping=False, mapping_sizes=[10, 4], skips=[4], siren=True, t_embedding_dims=16, beta=1):
        ...
        print('SatNeRF: layers, feat: ', layers, feat)   #SatNeRF: layers, feat:  8 512
